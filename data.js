 ...
 */
GAME_DATA.wiki = {
    "社会": "由一定联系在一起的个体组成的复杂系统，具有群体性、联系性和整体性。",
    "社会学": "研究社会事实、社会互动及其规律的科学。",
    "社会角色": "与社会地位相一致的权利、义务和行为模式。",
    "角色冲突": "一个人同时扮演多个角色时，不同角色要求之间产生的矛盾。",
    "科层制": "韦伯提出的理想类型，指一种权力依职能分工、按层级组织的行政管理体制。"
};

// 设施系统数据定义
GAME_DATA.facilities = [
    { id: 'f1', name: "接待大厅", emoji: "🏛️", baseCost: 100, desc: "管理日常事务与签到" },
    { id: 'f2', name: "档案室", emoji: "📁", baseCost: 150, desc: "记录学术历史与成就" },
    { id: 'f3', name: "会议室", emoji: "🪑", baseCost: 200, desc: "解锁专家咨询功能" },
    { id: 'f4', name: "实验室", emoji: "🔬", baseCost: 400, desc: "提升研究方法学习效率" }
];
    },
